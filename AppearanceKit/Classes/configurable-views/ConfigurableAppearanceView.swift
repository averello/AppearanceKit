//
//  ConfigurableAppearanceView.swift
//  AppearanceKit
//
...
/// A view that its appearance can be configured by a `UIContentAppearance`.
///
/// The default size of a `ConfigurableAppearanceView` is the same as its
...
open class ConfigurableAppearanceView: UIView, ConfigurableUIContent {
    ...
    /// An optional background view for the view.
    ///
